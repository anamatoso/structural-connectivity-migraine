...
# Example to plot matrix.mat (in which the variable in matlab is called matrix) separating the hemispheres (1). (Using AAL116)
# python3 plot_connectogram.py matrix.mat 1 
