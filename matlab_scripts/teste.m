...
% To test if everything is alright before the main code, namely to see
% which is the best number of streamlines, to test convergence and to
% lightly compare and analyse algorithms
a=load_data('/Users/ana/Documents/Ana/universidade/Tese/Code/matlab_scripts/matrices data','*.csv');
