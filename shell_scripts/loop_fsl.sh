...
SUBS_premenstrual_resto="sub-control031_ses-premenstrual sub-control033_ses-premenstrual sub-control035_ses-premenstrual sub-control044_ses-premenstrual sub-control046_ses-premenstrual sub-control048_ses-premenstrual sub-control049_ses-premenstrual"
SUBS_ictal_resto="sub-patient003_ses-ictal sub-patient005_ses-ictal sub-patient006_ses-ictal sub-patient013_ses-ictal sub-patient038_ses-ictal sub-patient034_ses-ictal sub-patient041_ses-ictal sub-patient045_ses-ictal sub-patient052_ses-ictal"

all="$SUBS_premenstrual_resto $SUBS_ictal_resto"
