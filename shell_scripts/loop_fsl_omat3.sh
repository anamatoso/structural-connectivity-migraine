...
all="$SUBS_midcycle $SUBS_interictal $SUBS_premenstrual $SUBS_ictal"

for i in $all; do
	atlasxgmwm="${i}/mrtrix_outputs_bvals2/gmwmseed_atlas.mif"
	/strombolihome/amatoso/tese/divide_atlas_seedgmwm.sh $atlasxgmwm $i
done
