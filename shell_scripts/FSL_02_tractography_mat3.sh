...
#/home/amatoso/tese/divide_atlas.sh "${SUBDIR}/mrtrix_outputs_bvals2/atlas.mif" $SUBDIR
ROIS="${MAINDIR2}/${DIR}/list_rois.txt"
...
atlas="${MAINDIR2}/${DIR}/mrtrix_outputs_bvals2/atlas.nii.gz"
...
cd $output_dir
cp fdt_network_matrix "${MAINDIR2}/matrix_data/${DIR}_fsl_matrix_bval2_omat3"
cd ..
rm -rf $output_dir
